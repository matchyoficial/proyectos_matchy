            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Expanded(child: Text('CAFÉS', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: kTitleSize, fontWeight: FontWeight.w900, letterSpacing: 1.2, fontFamily: 'Poppins'))),
              ...
              Expanded(
                child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                  stream: FirebaseFirestore.instance.collection('lugares').where('tipos', arrayContains: 'cafe').where('activo', isEqualTo: true).orderBy('orden').snapshots(),
